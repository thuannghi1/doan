...
class NguoidungsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nguoidung" do
    assert_difference("Nguoidung.count") do
      post nguoidungs_url, params: { nguoidung: { DiaChi: @nguoidung.DiaChi, Email: @nguoidung.Email, MatKhau: @nguoidung.MatKhau, SDT: @nguoidung.SDT, TenND: @nguoidung.TenND, phai_id: @nguoidung.phai_id, quyen_id: @nguoidung.quyen_id } }
    end
  ...
  test "should update nguoidung" do
    patch nguoidung_url(@nguoidung), params: { nguoidung: { DiaChi: @nguoidung.DiaChi, Email: @nguoidung.Email, MatKhau: @nguoidung.MatKhau, SDT: @nguoidung.SDT, TenND: @nguoidung.TenND, phai_id: @nguoidung.phai_id, quyen_id: @nguoidung.quyen_id } }
